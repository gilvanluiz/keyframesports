...
} from 'src/Features/Telestrations/State';
import {
    EditMode,
    IAction,
    ITelestrationStateMgr,
} from 'src/Features/Telestrations/Types';
...
const soundBar = ({
    ...
    function handleRecordToggle() {
        const editMode: EditMode = 'record';
        const action = setModeAction(editMode) as IAction;
        telestrationStateMgr.dispatchAction(action);
    }
