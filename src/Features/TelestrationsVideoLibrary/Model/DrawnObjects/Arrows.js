...
export class FreehandArrow {
    constructor(manager, color, borderColor, zAngle, arrowType) {
        this.coords = [];
        this.color = color;
        this.borderColor = borderColor;
        this.zAngle = zAngle;
        this.manager = manager;
        this.type = arrowType; // 0 - default, 1 - dashed
        this.timer = 0;
        this.lastCoord = null;
        ...
        this.animation = null;
        this.hasBorder = true;
        this.lineWidth = manager.arrowWidth;
...
export class Arrow {
    constructor(manager, color, borderColor, hasBorder, zAngle, arrowType) {
        this.dots = [];
        this.color = color;
        this.borderColor = borderColor;
        this.zAngle = zAngle;
