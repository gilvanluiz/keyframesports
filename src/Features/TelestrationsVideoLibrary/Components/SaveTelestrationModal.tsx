...
import { beamVideo, IUploadVideo } from 'src/Utilities/AwsVideoLibrary';
...
const saveTelestrationModal = ({
    ...
    const onSaveClick = () => {
        ...
        const videoPayload = pipe(
            ...
            cancelTokenSource: localStateMgr.state.VideoUploadingCancelToken,
            saveTelestratedVideoLink: (value: string) =>
                dispatchAction(setLastTelestratedVideo(value)),
        }) as IUploadVideo;
...
export const SaveTelestrationModal = compose(
