            ...
            case 'chromakey': {
                return {
                    ...
                    body: (
                        <Box>
                            <Typography>
                                Click anywhere on the soccer field to add the
                                mask.
                            </Typography>
                            <br />
                            <Typography>
                                Make sure to cover the whole field with this
                                mask but not select anything else like a player
                                or field markings.
                            </Typography>
                            <br />
                            <Typography>
                                If you select an area that isn't the field, hit
                                undo <Undo className={classes.mediumTextIcon} />
                                or clear
                                <ClearIcon
                                    className={classes.maskHintIcon}
                                    fontSize='large'
                                />
                                to start again.
                            </Typography>
                            ...
                            <Typography>
                                Hit save
                                <SaveIcon className={classes.mediumTextIcon} />
                                once you have applied your mask.
                            </Typography>
                        </Box>
                    ),
                };
